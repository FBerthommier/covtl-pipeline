...
#   PORT VOCALIQUE jd3 (mission triangle 23/09) : c2<-c2_jd3, c0<-0.9067*c0_jd3, c1<-c1_jd3 (matrice propre effondree : triangle 4 % de jd3, levres fermees sur O/o/2) ; cibles jd3 avec rho_i=1.20, rho_y=1.10, rho_2=0.60 ; cf. covtl_m01_w02/
#   CONSONNES sur matrice portee (23/09) : TTY c1 -0.4597 -> +0.490300 (Delta+0.95, theta dental 270 deg — onset 0.90 + marge ; d/i palier 0.009 cm2 documente) ; g_vel : fermeture seulement a rho 3.0 — residuel documente
"""
...
CO_VTL: Dict[str, Tuple[float, float, float]] = {
    'HX':  (0.722233, 0.503702, 0.000000),
    'HY':  (-5.155867, 1.130438, 3.361756),
    'JX':  (-0.025000, 0.045335, 2.094395),
    'JA':  (-3.371067, 1.178217, 5.354986),
    'LP':  (0.382967, 0.559471, 1.042238),
    'LD':  (0.466400, 0.528606, 4.092457),
    'TCX':  (1.090767, 1.385594, 5.373564),
    'TCY':  (-0.914133, 0.626480, 6.031444),
    'TTX':  (4.044400, 0.754723, 4.466027),
    'TTY':  (0.290300, 0.983135, 0.116283),
    'TBX':  (2.795833, 1.153363, 4.907833),
    'TBY':  (0.159033, 0.758411, 0.076068),
    'TS1':  (0.248667, 0.044821, 0.545179),
    'TS2':  (0.031067, 0.029448, 4.484628),
    'TS3':  (0.032933, 0.108268, 2.897420),
}
