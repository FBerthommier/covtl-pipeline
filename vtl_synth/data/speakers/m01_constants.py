...
Ne pas éditer à la main : régénérer via
    python adapt_speaker.py m01.speaker
...
#   LD  : c1=c0=0.707930 (fermeture min=0 à ρ=1) ; c1 x0.8 = 0.566344
...
# =============================================================================
# COVTL — coefficients (c1, c0, c2) dérivés du .speaker (m01)
# =============================================================================
...
CO_VTL: Dict[str, Tuple[float, float, float]] = {
    'HX':  ( 0.605600,  0.606147, 0.042494),
    'HY':  (-4.837600,  0.305529, 3.945073),
    'JX':  ( 0.000000,  0.000000, 0.000000),
    'JA':  (-3.033267,  1.135952, 5.356839),
    'LP':  (-0.218967,  0.556458, 1.765510),
    'LD':  ( 0.566344,  0.707930, 3.428295),
    ...
    'TS2':  ( 0.049333,  0.069179, 5.506331),
    'TS3':  ( 0.018667,  0.037333, 5.235988),
}
...
# autres voyelles : moindres carrés ρ ≤ 1 ; '@' : centroïde du triangle.
    # '@' : (0.750, 123°) choisie par coût multi-critères sur la fonction d'aire
...
# =============================================================================
# Presets glottaux (modèle géométrique natif du speaker m01)
# =============================================================================
@dataclass
class GlottisPreset:
    name: str
...
JD3_GLOTTIS_PRESETS: Dict[str, GlottisPreset] = {
    'default': GlottisPreset(
            name='default',
            f0=120, pressure=8000, lag=1.222,
            x_bottom=0.054, x_top=0.072, chink_area=0,
            rel_amp=1, double_pulsing=0.05,
            pulse_skewness=0.502, f0_flutter=0, aspiration_strength=0,
        ),
    'h': GlottisPreset(
            name='h',
            f0=138.1, pressure=0, lag=1.222,
            x_bottom=0.04, x_top=0.04, chink_area=0.05,
    ...
    'pressed': GlottisPreset(
            name='pressed',
            f0=65.7, pressure=8000, lag=1.222,
            x_bottom=0.011, x_top=0.011, chink_area=0.05,
            rel_amp=1, double_pulsing=0.05,
            pulse_skewness=0.502, f0_flutter=0, aspiration_strength=0,
        ),
    'stop': GlottisPreset(
    ...
    'voiced-fricative': GlottisPreset(
            ...
            f0=116.938, pressure=8000, lag=1.222,
            x_bottom=0.08, x_top=0.08, chink_area=0.05,
            rel_amp=1, double_pulsing=0.05,
            pulse_skewness=0.5, f0_flutter=0, aspiration_strength=0,
        ),
    'voiced-plosive': GlottisPreset(
            name='voiced-plosive',
            f0=112.217, pressure=8000, lag=1.222,
            x_bottom=0.1, x_top=0.1, chink_area=0.02,
            rel_amp=1, double_pulsing=0.05,
            pulse_skewness=0.5, f0_flutter=0, aspiration_strength=0,
        ),
    'voiceless-fricative': GlottisPreset(
            name='voiceless-fricative',
            f0=151.27, pressure=0, lag=1.222,
            x_bottom=0.14, x_top=0.14, chink_area=0,
            rel_amp=0, double_pulsing=0.05,
            pulse_skewness=0.5, f0_flutter=0, aspiration_strength=0,
        ),
    'voiceless-plosive': GlottisPreset(
            name='voiceless-plosive',
            f0=113.303, pressure=7999.981, lag=1.222,
            x_bottom=0.15, x_top=0.15, chink_area=0,
            rel_amp=-1, double_pulsing=0.05,
            pulse_skewness=0.5, f0_flutter=0, aspiration_strength=0,
        ),
}
...
# =============================================================================
TBY_VELAR_OCCLUSION_MIN: float = 1.281348
